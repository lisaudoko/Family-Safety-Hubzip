...
- **What**: Created `CLAUDE.md`, `AGENTS.md`, the full `AI_CONTEXT/` directory (13 files), and `docs/` (12 files) by inspecting the actual codebase (API routes, Drizzle schema, mobile app).
